lambda=13e-9;%wavelength of interference wave
lambdaex=5e-7;%wavelength of weak interference wave
k=2*pi/lambda;%wavenumber of interference wave
kex=2*pi/lambdaex;%wavenumber of weak nterference wave
L=1e-4;%distance of image plane to source plane
dslitwidth=1e-8;% width between fringes
dwidth=8e-6;%width between slit
N=700;%number of fringes
